...
namespace AvlTree
{
    class Program {
        static void Main(string[] args)  {
            ...
            tree.Add(7);     tree.Add(15);
            tree.Add(2);     tree.Delete(7);
    ...
    class AVL {
        ...
        private Node RecursiveInsert(Node current, Node n) {
            if (current == null) { current = n;  return current;  }
        ...
        private Node Delete(Node current, int target) {
            ...
            if (current == null) { return null; }
                ...
                if (target < current.data) {
                    ...
                    if (current.right != null) {/*delete its inorder successor*/
        ...
        public void Find(int key) {
            if (Find(key, root).data == key) {Console.WriteLine("{0} was found!", key);}
        ...
        private int max(int l, int r) {  return l > r ? l : r;  }
